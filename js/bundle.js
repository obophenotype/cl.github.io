...
var _backtotop = require("./backtotop/backtotop");

window.initNavbar = _navbar.initNavbar;
window.initSidebar = _sidebar.initSidebar;
window.initBackToTop = _backtotop.initBackToTop;

},{"./backtotop/backtotop":5,"./navbar/navbar":7,"./sidebar/sidebar":9}],7:[function(require,module,exports){
"use strict";
...
exports.themeColors = exports.env = exports.demoData = void 0;
var env = 'development';
exports.env = env;
var themeColors = {
  primary: '#00d1b2',
...
function initModals() {
  var targets = document.querySelectorAll(".modal-trigger");
...
"use strict"; //Alpine JS and plugins import

var _alpinejs = _interopRequireDefault(require("alpinejs"));

var _intersect = _interopRequireDefault(require("@alpinejs/intersect"));

var _fern = _interopRequireDefault(require("@ryangjchandler/fern"));

var _constants = require("./libs/utils/constants");

var _pageloader = require("./libs/components/pageloader/pageloader");

var _utils = require("./libs/utils/utils");

require("./libs/components");

require("./ols-autocomplete.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

window.Alpine = _alpinejs["default"]; //Init intersect plugin

_alpinejs["default"].plugin(_intersect["default"]); //Init Fern plugin


_alpinejs["default"].plugin(_fern["default"]); //Init Fern persisted store


_alpinejs["default"].persistedStore("app", {
...
},{"./libs/components":6,"./libs/components/pageloader/pageloader":8,"./libs/utils/constants":10,"./libs/utils/utils":11,"./ols-autocomplete.js":13,"@alpinejs/intersect":1,"@ryangjchandler/fern":2,"alpinejs":3,"feather-icons":4}],13:[function(require,module,exports){
"use strict";
...
require = function t(e, o, i) {
  ...
  "ols-autocomplete": [function (t, e, o) {
    e.exports = autocomplete = function (_autocomplete) {
